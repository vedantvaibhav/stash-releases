...
extension FileDropStorage {
    /// Native `NSAlert` confirmation for trash-icon deletes. NSAlert renders
    /// its own modal window — no SwiftUI binding, no shared state, no scrim
    /// or overlay on our side.
